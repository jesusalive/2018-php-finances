...
<html lang="pt-br">
    ...
    <body>
        ...
        <DIV class="centro">
        <h1 class="textotit">ADICIONE UMA CATEGORIA DE ENTRADA DE DINHEIRO</h1> <br> <br> <br>
        <form action="addcatent.php" method="POST">
            <span class = "txinput"> Nome da Categoria </span> <br> <br>
            <input type="text" name = "cat" class="input" placeholder="Ex: Salário / Ex: Lanche"> <br> <br> <br> <br> <br>
...
<?php
   ...
   if(!empty($_POST['cat']) && isset($_POST['btn'])){
        ...
        $sqlselec= "SELECT * FROM ctg_entradas WHERE categoria = '$novacat'";
        ...
        if($linhas > 0){
            ...
            $sqlinsert = "INSERT INTO ctg_entradas VALUES (NULL,'$novacat');";
            $query1 = mysqli_query($con, $sqluse);
